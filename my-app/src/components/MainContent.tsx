...
import luxembourgFlag from '../assets/luxembourgFlag.jpg'; // Ensure the flag image is placed in the src/assets directory

const MainContent: React.FC = () => {
    return (
        <main className="flex flex-col items-center justify-center min-h-screen text-center bg-gray-100">
            <img src={luxembourgFlag} alt="Luxembourg Flag" className="mb-4 w-1/3 h-auto rounded-lg shadow-lg" />
